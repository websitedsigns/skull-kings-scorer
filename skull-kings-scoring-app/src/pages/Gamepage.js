    ...
    <div className="gamepage">
      ...
      {!scoringPhase ? (
        <>
          ...
          <button onClick={handleBidSubmit} disabled={bids.includes('')}>
            Start Round
          </button>
        </>
      ) : (
        <>
          ...
          <button onClick={handleScoringSubmit}>Submit Scores</button>
        </>
      )}
      ...
      <button onClick={togglePopup}>View Round Scores</button>
